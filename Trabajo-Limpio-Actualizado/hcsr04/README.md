...
| ---: | :---: | :---: |
| TRIGGER | CONFIG_TRIGGER_PIN | 13 |
| ECHO | CONFIG_ECHO_PIN | 12 |

These connections are configured with `idf.py menuconfig` under `Component config -> HCSR04 menu`.
If the HC-SR04 is powered at 5 V, route ECHO through a voltage divider before connecting it to the ESP32-S3.
